  ...
  return (
    <main style={{ background: 'var(--dark)' }}>
      ...
      <section style={{
        ...
        padding: isMobile ? '80px 20px 40px' : '100px 56px 64px',
      ...
      <section style={{
        ...
        <div style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: isActive
                    ? (isMobile ? '24px 20px 28px' : '40px 48px 44px')
                    : (isMobile ? '18px 20px' : '32px 48px'),
              ...
              >
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    paddingTop: 20,
                    paddingLeft: isMobile ? 0 : 62,
                    maxWidth: 340,
                  }}>{tab.body}</p>
                  <div style={{ paddingLeft: isMobile ? 0 : 62, paddingTop: 28 }}>
          ...
          {/* Progress indicator */}
          <div style={{ flex: 1, display: 'flex', alignItems: 'flex-end', padding: isMobile ? '24px 20px' : '32px 48px' }}>
